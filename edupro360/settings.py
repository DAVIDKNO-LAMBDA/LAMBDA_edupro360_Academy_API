...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-gongs8vf+(!714-fncakrspj$vx5_6billswq&(jk+w^hq3ne5')
...
# Celery Beat Schedule (se configurará en Notifications app)
